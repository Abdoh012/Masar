...
export function PendingNextSteps() {
  return (
    <div className="rounded-xl border border-border bg-neutral-200/60 p-4 text-left dark:bg-white/4">
      ...
      <ul className="space-y-2.5">
        {PENDING_APPROVAL.nextSteps.items.map((item) => (
          <li key={item} className="flex items-start gap-2.5">
            <span className="mt-[0.45em] size-1.5 shrink-0 rounded-full bg-secondary-500" />
