...
// Route-level error boundary for /certificates (architecture R2): renders when
// the CertificatePageContent server fetch fails (the container throws), matching
// the polished full-page state conventions from app/error.tsx with an in-page
// scope.
    ...
    >
      ...
      >
        ...
        <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
          An unexpected error occurred while loading your certificates.
        </p>
