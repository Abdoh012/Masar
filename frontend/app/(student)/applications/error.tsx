...
// Route-level error boundary for /applications (architecture R2): renders
// when the My Applications fetch fails (container throws), matching the
// polished full-page state conventions from app/error.tsx with an in-page
// scope.
