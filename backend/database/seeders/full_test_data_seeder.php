...
function masar_seed(PDO $pdo): void
{
    ...
    $tdefs = [
        'backend-intern' => [
            ...
            'starts_at' => $dt(15), 'ends_at' => $dt(105),
        ...
        'ai-intern' => [
            ...
            'starts_at' => $dt(20), 'ends_at' => $dt(120),
        ...
        'medical-intern' => [
            ...
            'training_type' => 'hands_on', 'mode' => 'onsite', 'is_paid' => 0,
            'may_lead_to_employment' => 0, 'capacity' => 5,
            'starts_at' => $dt(25), 'ends_at' => $dt(110),
        ...
        'data-analytics' => [
            ...
            'may_lead_to_employment' => 1, 'capacity' => 4,
            'starts_at' => $dt(16), 'ends_at' => $dt(100),
