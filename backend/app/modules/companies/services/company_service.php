...
function company_service_resolve_specialization_ids(
    ...
    if (
        ...
        /*
         * Industry accepts a single specialization ID, a single name, or a
         * list of IDs and/or names. Each entry is resolved against the
         * specializations lookup table (the same list students choose from).
         */
        ...
        if (
            ...
            foreach ($data['industry'] as $industry_value) {
                ...
                if (
                    ...
                    (
                        is_string($industry_value)
                        &&
                        ctype_digit(trim($industry_value))
                    )
                ) {
            ...
            is_int($data['industry'])
            ||
            (
                is_string($data['industry'])
                &&
                ctype_digit(trim($data['industry']))
            )
        ) {
