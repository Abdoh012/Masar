...
function training_service_create(
    ...
    */
    ...
    if (
        !training_repository_specialization_exists(
        ...
        return [
            ...
            'message' =>
                'The selected specialization is not recognized.',
    ...
    */
    ...
    if ($training) {
        ...
        $training['specialization'] =
            training_repository_get_specialization(
                (int) $training['specialization_id']
            );
    }
...
function training_service_list(
    ...
    */
    ...
    $student_specialization_id = null;
    ...
    if (
        ...
        */
        ...
        $normalized_filters['match_specialization_ids'] =
            [$student_specialization_id];
    }
...
function training_service_saved_list(
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Student Specialization Context
    |--------------------------------------------------------------------------
    |
    | Saved trainings are scoped to the student's single primary
    | specialization (training_listings.specialization_id), so each card
    | carries exactly the specialization that belongs to the student. A
    | student with no specialization set gets an empty result set.
    |
    */
    ...
    if ($student_specialization_id === null) {
        ...
        return [
            ...
            'message' =>
                'Saved trainings retrieved successfully.',
