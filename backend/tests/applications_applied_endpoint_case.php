...
/**
 * MASAR - Applications Applied Endpoint Case Runner (internal)
 *
 * One-shot subprocess executed by tests/applications_applied_endpoint_regression.php.
 * NOT a standalone test.
 *
 * Usage: php tests/applications_applied_endpoint_case.php <guest|bearer> <token> [request_uri]
 *
 ...
 * /api/v1/applications/applied), and prints:
 *
 *     STATUS=<http_code>
 *     BODY=<raw json body>
 */
...
$token    = (string) ($argv[2] ?? '');
$request_uri = (string) ($argv[3] ?? '/api/v1/applications/applied');
