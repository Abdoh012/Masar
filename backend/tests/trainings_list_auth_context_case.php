...
/**
 * MASAR - Trainings List Auth Context Scenario Runner (internal)
 *
 * One-shot subprocess executed by tests/trainings_list_auth_context_regression.php.
 * NOT a standalone test.
 *
 * Usage: php tests/trainings_list_auth_context_case.php <guest|bearer> <token> [request_uri]
 *
 ...
 * /api/v1/trainings/list), and prints:
 *
 *     STATUS=<http_code>
 *     BODY=<raw json body>
 */
...
$token    = (string) ($argv[2] ?? '');
$request_uri = (string) ($argv[3] ?? '/api/v1/trainings/list');

$_SERVER['REQUEST_METHOD'] = 'GET';
$_SERVER['REQUEST_URI']    = $request_uri;
$_SERVER['QUERY_STRING']   = 'page=1&limit=20&sort=newest';
$_GET = ['page' => '1', 'limit' => '20', 'sort' => 'newest'];
$_COOKIE = [];
...
require BASE . 'routes/trainings.php';